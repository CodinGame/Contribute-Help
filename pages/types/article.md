...
[Edit 2021/05/28] Updates on the CodinGame's blog are currently paused. To contribute an article on CodinGame, use Tech.io (see below)
...
1. **Introduction**: Contact Thibaud (thibaud@codingame.com or on [Discord](https://discord.gg/qAKXEEv)). He'll help you to publish the article from A to Z.
